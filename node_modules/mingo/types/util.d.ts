 ...
 * @returns {Number}
 */
export declare function compare<T = Any>(a: T, b: T): number;
/**
...
export declare class HashMap<K, V> extends Map<K, V> {
     ...
     */
    static init<K, V>(fn?: HashFunction): HashMap<K, V>;
    clear(): void;
    /**
 ...
 */
export declare function intersection(input: Any[][], hashFunc?: HashFunction): Any[];
/**
 * Flatten the array
 *
 ...
 * @return {Array}
 */
export declare function unique(input: Any[], hashFunc?: HashFunction): Any[];
/**
 ...
 */
export declare function stringify(v: Any, refs?: Set<Any>): string;
/**
 * Generate hash code.
 ...
 * @returns {number|null}
 */
export declare function hashCode(value: Any, hashFunc?: HashFunction): number;
/**
 ...
 * @returns {Map<Any, Any[]>}
 */
export declare function groupBy(collection: Any[], keyFunc: Callback<Any>, hashFunc?: HashFunction): Map<Any, Any[]>;
