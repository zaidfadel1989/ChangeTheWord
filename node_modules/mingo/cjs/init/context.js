...
var context_default = () => import_core.Context.init().addAccumulatorOps(accumulatorOperators).addExpressionOps(expressionOperators).addPipelineOps(pipelineOperators).addProjectionOps(projectionOperators).addQueryOps(queryOperators).addWindowOps(windowOperators);
