  ...
  for (const key of expressionKeys) {
    ...
    if ((0, import_util.isNumber)(subExpr) || (0, import_util.isBoolean)(subExpr)) {
      ...
      if (projectFn) {
        ...
        (0, import_util.assert)(subExprKeys.length > 0, `Invalid empty sub-projection: ${key}`);
        handlers[key] = (o) => {
          ...
          const res = fn(o);
          if ((0, import_util.has)(o, key)) return res;
          return !(0, import_util.isObject)(res) || Object.keys(res).length ? res : void 0;
        };
      }
    } else {
