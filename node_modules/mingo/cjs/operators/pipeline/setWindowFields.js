...
const $setWindowFields = (collection, expr, options) => {
  ...
  for (const outputExpr of Object.values(expr.output)) {
    ...
    (0, import_util.assert)(
      !!(0, import_core.getOperator)(import_core.OpType.WINDOW, op, options) || !!(0, import_core.getOperator)(import_core.OpType.ACCUMULATOR, op, options),
      ...
      const config = {
        ...
        func: {
          left: (0, import_core.getOperator)(
            import_core.OpType.ACCUMULATOR,
            op,
            options
          ),
          right: (0, import_core.getOperator)(import_core.OpType.WINDOW, op, options)
        },
        args: outputExpr[op],
        field,
